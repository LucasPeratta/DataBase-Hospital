...
from model.turnos_model import programarTurno, actualizarTurno, cancelarTurno, verTurnosPorPaciente, verTurnosPorMedico
...
def cancelar_turno_controller(id_cita):
    cancelarTurno(id_cita)  # Llama a la función del modelo para cancelar el turno
